    ...
    <div className="space-y-8">
      ...
      <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm p-8 rounded-2xl shadow-[0_8px_32px_0_rgba(100,100,150,0.15)] border border-white/50 dark:border-white/10">
        <div className="flex items-center gap-3 mb-6">
          <Wallet className="text-[#0F172A] dark:text-slate-400 w-6 h-6" />
        ...
        <form className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
          <div className="col-span-1">
            ...
            <select
              className="w-full bg-white/50 dark:bg-slate-800/50 border border-slate-300/70 dark:border-slate-700/70 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-[#0F172A]/50 focus:border-[#0F172A] outline-none appearance-none text-slate-900 dark:text-white"
              id="bank-name"
            >
      ...
      <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm p-8 rounded-2xl shadow-[0_8px_32px_0_rgba(100,100,150,0.15)] border border-white/50 dark:border-white/10">
        <div className="flex items-center gap-3 mb-6">
          <History className="text-[#0F172A] dark:text-slate-400 w-6 h-6" />
          <h2 className="text-xl font-bold text-slate-800 dark:text-white">
            Transaction History
          </h2>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            <thead className="text-xs text-slate-500 dark:text-slate-400 uppercase bg-slate-100/50 dark:bg-slate-800/50">
              <tr>
                <th
                  className="px-6 py-4 font-semibold rounded-l-lg"
                  scope="col"
                >
                  Date
                </th>
                ...
                <th
                  className="px-6 py-4 font-semibold text-center rounded-r-lg"
                  scope="col"
                >
                  Status
                </th>
            ...
            <tbody>
              <tr className="border-b border-slate-200/50 dark:border-slate-800/50">
                ...
                <td className="px-6 py-4 text-slate-600 dark:text-slate-300">
                  Payout for property inspection
                </td>
              ...
              <tr className="border-b border-slate-200/50 dark:border-slate-800/50">
                ...
                <td className="px-6 py-4 text-slate-600 dark:text-slate-300">
                  Partial compensation for client no-show
                </td>
                <td className="px-6 py-4 font-semibold text-right text-green-600 dark:text-green-400">
                  + ₦15,000.00
                </td>
