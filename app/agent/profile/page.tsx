...
import { Bell, MessageSquare, ChevronDown, Settings, Shield, User, Wallet, Briefcase, FileText } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gradient-to-br from-[#f3e7ff] to-[#e3eeff] dark:from-[#1a1829] dark:to-[#1e294e] p-10 overflow-y-auto">
            ...
            <div className="space-y-8">
                ...
                <div className="flex flex-wrap gap-2 bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm p-2 rounded-xl shadow-[0_8px_32px_0_rgba(100,100,150,0.15)] border border-white/50 dark:border-white/10 w-fit">
                    <button className="px-5 py-2 rounded-lg text-sm font-semibold bg-gradient-to-r from-purple-500 to-blue-500 text-white shadow-md shadow-purple-500/20">Profile</button>
                    <button className="px-5 py-2 rounded-lg text-sm font-semibold text-slate-600 dark:text-slate-300 hover:bg-white/50 dark:hover:bg-slate-800/50 transition-colors">KYC Verification</button>
                    <button className="px-5 py-2 rounded-lg text-sm font-semibold text-slate-600 dark:text-slate-300 hover:bg-white/50 dark:hover:bg-slate-800/50 transition-colors">Wallet & Payments</button>
                    <button className="px-5 py-2 rounded-lg text-sm font-semibold text-slate-600 dark:text-slate-300 hover:bg-white/50 dark:hover:bg-slate-800/50 transition-colors">Business Details</button>
                </div>
                ...
                <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm p-8 rounded-2xl shadow-[0_8px_32px_0_rgba(100,100,150,0.15)] border border-white/50 dark:border-white/10">
                    ...
                    <div className="space-y-5">
                        <label className="flex items-start justify-between cursor-pointer group">
                            <div>
                                <p className="font-semibold text-slate-700 dark:text-slate-200">New Client Requests</p>
                                <p className="text-sm text-slate-500 dark:text-slate-400">Get notified about new requests from potential clients</p>
                            </div>
                        ...
                        <label className="flex items-start justify-between cursor-pointer group">
                            <div>
                                <p className="font-semibold text-slate-700 dark:text-slate-200">Inspection Confirmations</p>
                                <p className="text-sm text-slate-500 dark:text-slate-400">Receive notifications when clients confirm an inspection</p>
                            </div>
                            <input type="checkbox" defaultChecked className="w-5 h-5 rounded border-slate-300 text-purple-600 focus:ring-purple-500 cursor-pointer" />
                        </label>
                        <label className="flex items-start justify-between cursor-pointer group">
                            <div>
                                <p className="font-semibold text-slate-700 dark:text-slate-200">Earnings Updates</p>
                                <p className="text-sm text-slate-500 dark:text-slate-400">Get notified when you receive payments</p>
                            </div>
                            <input type="checkbox" defaultChecked className="w-5 h-5 rounded border-slate-300 text-purple-600 focus:ring-purple-500 cursor-pointer" />
                        </label>
                        <label className="flex items-start justify-between cursor-pointer group">
