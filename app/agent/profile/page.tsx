...
export default function AgentProfilePage() {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[#f3e7ff] to-[#e3eeff] dark:from-[#1a1829] dark:to-[#1e294e] flex flex-col">
            <div
                ...
                <div className="space-y-8">
                    ...
                    <div className="flex items-center gap-2 border-b border-slate-200/80 dark:border-slate-700/80 mb-6">
                        <button
                            ...
                            className={`px-4 py-3 text-sm font-semibold transition-all border-b-2 ${activeTab === 'profile'
                        ...
                        <button
                            ...
                            className={`px-4 py-3 text-sm font-semibold transition-all border-b-2 ${activeTab === 'kyc'
                                ? 'text-slate-800 dark:text-slate-100 border-purple-500'
                                : 'text-slate-500 dark:text-slate-400 border-transparent hover:text-slate-700 dark:hover:text-slate-300'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-3 text-sm font-semibold transition-all border-b-2 ${activeTab === 'wallet'
                                ? 'text-slate-800 dark:text-slate-100 border-purple-500'
                                : 'text-slate-500 dark:text-slate-400 border-transparent hover:text-slate-700 dark:hover:text-slate-300'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-3 text-sm font-semibold transition-all border-b-2 ${activeTab === 'business'
                                ? 'text-slate-800 dark:text-slate-100 border-purple-500'
                                : 'text-slate-500 dark:text-slate-400 border-transparent hover:text-slate-700 dark:hover:text-slate-300'
                                }`}
                        >
