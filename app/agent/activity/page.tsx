        ...
        <header className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400 mt-1">
              Manage your tasks, updates, and client communications.
            </p>
          </div>
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between border-b border-slate-200/80 dark:border-slate-700/80">
            <div className="flex items-center gap-2">
              <button className="px-4 py-3 text-slate-800 dark:text-slate-100 font-semibold border-b-2 border-purple-500">
                All
              </button>
              <button className="px-4 py-3 text-slate-500 dark:text-slate-400 font-medium">
                Action Required
              </button>
              <button className="px-4 py-3 text-slate-500 dark:text-slate-400 font-medium">
                Updates
            ...
            <a
              className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white font-medium transition-colors"
              href="#"
            >
                ...
                <div className="p-5 flex items-start gap-5">
                  ...
                  <div className="flex-grow">
                    <div className="flex items-center justify-between">
                      <div>
                        <span className="text-sm font-semibold px-2.5 py-1 rounded-full bg-red-100 text-red-700 dark:bg-red-900/50 dark:text-red-300">
                          New Lead
                        </span>
                        <p className="font-bold text-lg text-slate-800 dark:text-slate-100 mt-2">
                          New client request from John Appleseed for a 2-bedroom
                          apartment
                        </p>
                      </div>
                    </div>
                    <div className="mt-3 pr-8">
                      <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
                        The client is looking for properties in the Lekki Phase
                        1 area with a budget of $2,500/month.
                      </p>
                      <div className="flex items-center gap-3">
                        <button className="bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-semibold py-2 px-4 rounded-lg transition-colors shadow-sm text-sm">
                          Dismiss
                        </button>
              ...
              <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm rounded-2xl shadow-[0_8px_32px_0_rgba(100,100,150,0.15)] border border-white/50 dark:border-white/10 relative overflow-hidden">
                <div className="p-5 flex items-start gap-5">
                  ...
                  <div className="flex-grow">
                    <div className="flex items-center justify-between">
                      <div>
                        <span className="text-sm font-semibold px-2.5 py-1 rounded-full bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300">
                          Response Needed
                        </span>
                        <p className="font-semibold text-slate-800 dark:text-slate-100 mt-2">
                          Client asked a question about "123, Queen Street"
                        </p>
                      </div>
                    </div>
                    <div className="mt-3 pr-8">
                      <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
                        "Is it possible to schedule a viewing for this Saturday
                        morning?" - Jane Doe
                      </p>
                      <div className="flex items-center gap-3">
                        <button className="bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-semibold py-2 px-4 rounded-lg transition-colors shadow-sm text-sm">
              ...
              <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm rounded-2xl shadow-[0_8px_32px_0_rgba(100,100,150,0.15)] border-2 border-green-300 dark:border-green-700/80 relative overflow-hidden">
                ...
                <div className="p-5 flex items-start gap-5">
                  ...
                  <div className="flex-grow">
                    <div className="flex items-center justify-between">
                      <div>
                        <span className="text-sm font-semibold px-2.5 py-1 rounded-full bg-green-100 text-green-700 dark:bg-green-900/50 dark:text-green-300">
                          Inspection Confirmed
                        </span>
                        <p className="font-bold text-lg text-slate-800 dark:text-slate-100 mt-2">
                          Inspection confirmed for 456, King Ave tomorrow at
                          2:00 PM
                        </p>
                      </div>
                    </div>
                    <div className="mt-3 pr-8">
                      <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
                        Client Jane Doe has confirmed the inspection time.
                        Please prepare the property accordingly.
                      </p>
                      <div className="flex items-center gap-3">
                        <button className="bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-semibold py-2 px-4 rounded-lg transition-colors shadow-sm text-sm">
                          Mark as Done
              ...
              <div className="bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm rounded-2xl shadow-[0_8px_32px_0_rgba(100,100,150,0.15)] border border-white/50 dark:border-white/10 relative overflow-hidden opacity-70">
                <div className="p-4 flex items-center justify-between gap-5">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-green-100 text-green-700 dark:bg-green-900/50 dark:text-green-300">
                          Payment Received
                        </span>
                        <p className="font-medium text-sm text-slate-700 dark:text-slate-200">
                          Payment received for inspection #4521
                        </p>
                      </div>
                      <p className="text-xs text-slate-500 dark:text-slate-400">
                        Client has paid the inspection fee for "Sunshine Villa".
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <p className="font-medium text-sm text-slate-700 dark:text-slate-200">
                          Listing "789 Bayview Dr" needs an update
                        </p>
                      </div>
                      <p className="text-xs text-slate-500 dark:text-slate-400">
                        The property status has changed to "Rented".
                      </p>
                    </div>
                  </div>
                </div>
