...
export default function Dashboard() {
  return (
    <div className="p-8 min-h-screen bg-[#F7F9FC] dark:bg-[#121826]">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white dark:bg-[#1A2233] p-6 rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.05)] flex flex-col justify-between">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Today's Schedule */}
            <div className="bg-white dark:bg-[#1A2233] p-6 rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.05)]">
              <h3 className="text-xl font-bold mb-4 text-slate-800 dark:text-white">Today's Schedule</h3>
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row items-start sm:items-center p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 gap-4 sm:gap-0">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white dark:bg-[#1A2233] p-6 rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.05)]">
              ...
              <div className="space-y-3">
                <button className="w-full flex items-center gap-3 p-4 rounded-lg bg-slate-100 dark:bg-slate-800/50 hover:bg-slate-200 dark:hover:bg-slate-800 transition-colors">
