        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-20 items-center justify-between">
            ...
            <div className="hidden md:flex items-center justify-end gap-4 w-64 flex-shrink-0">
              <Link
                href="/login"
                className="text-slate-600 font-semibold text-sm hover:text-navy-900 transition-colors"
              >
                Login
              </Link>
              <Link
                href="/signup"
                className="bg-coral text-white px-6 py-2.5 rounded-full text-sm font-bold hover:bg-coral-hover shadow-lg shadow-coral/20 transition-all transform hover:-translate-y-0.5"
              >
                Get Started
              </Link>
            </div>
      ...
      <main className="relative z-10">
            ...
            <div className="flex flex-col items-center justify-center px-4">
              <div className="w-full max-w-4xl mx-auto text-center">
                ...
                <p className="max-w-xl mx-auto text-slate-300 text-lg md:text-xl mb-10 leading-relaxed font-light">
                  The quiet marketplace for homeseekers. Define your terms,
                  receive matches from verified agents, and secure your next
                  home with confidence.
                </p>
                <div className="flex flex-col sm:flex-row gap-5 justify-center">
                  <Link
                    className="inline-flex items-center justify-center px-8 py-4 bg-coral text-white text-base font-bold rounded-full shadow-lg shadow-coral/30 hover:bg-coral-hover transition-all transform hover:-translate-y-1"
                    href="/signup"
                  >
                    Create Request
                  </Link>
        ...
        <div className="py-12 border-b border-slate-100/10 overflow-hidden">
          <div className="max-w-7xl mx-auto px-4">
            <p className="text-center text-xs font-bold text-slate-400 mb-10 uppercase tracking-[0.2em]">
              Our Coverage
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-20">
              <h2 className="font-display text-4xl md:text-5xl font-bold text-navy-900 mb-6 tracking-tight">
                Expert Matching, <br />
                <span className="text-coral">Zero Searching</span>
              </h2>
              <p className="text-slate-500 text-lg leading-relaxed">
                We've stripped away the noise of public listings. Here, the
                market comes to you through a curated, private channel.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="group bg-white p-8 rounded-2xl shadow-card hover:shadow-float transition-all duration-300 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-500 text-sm leading-relaxed">
                    Set your parameters—budget, location, lifestyle. The more
              ...
              <div className="group bg-white p-8 rounded-2xl shadow-card hover:shadow-float transition-all duration-300 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-500 text-sm leading-relaxed">
                    Verified top-tier agents review your request and submit only
                    their most relevant inventory.
                  </p>
                </div>
              </div>
              {/* Step 3 */}
              <div className="group bg-white p-8 rounded-2xl shadow-card hover:shadow-float transition-all duration-300 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-500 text-sm leading-relaxed">
                    Book inspections instantly. A small commitment fee ensures
                    exclusive attention from the agent.
                  </p>
                </div>
              </div>
              {/* Step 4 */}
              <div className="group bg-white p-8 rounded-2xl shadow-card hover:shadow-float transition-all duration-300 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-slate-500 text-sm leading-relaxed">
                    Negotiate and close through our secure platform, with funds
                    held in escrow until satisfaction.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-16 items-center">
              ...
              <div className="w-full lg:w-1/2">
                <h2 className="font-display text-4xl lg:text-5xl font-bold text-navy-900 mb-8 leading-tight">
                  ...
                  <span className="text-coral">Navigate the Market</span>
                </h2>
                <p className="text-slate-600 text-lg mb-10">
                  Traditional searching is reactive. DomiHive is proactive. We
                  built a platform where your intent drives the market, not the
                  other way around.
                </p>
                  ...
                  <div className="flex gap-5 items-start p-4 rounded-xl hover:bg-slate-50 transition-colors duration-300">
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 text-base leading-relaxed">
                        Our algorithm ensures you only see properties that hit
                        92% or more of your criteria. No compromises.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-5 items-start p-4 rounded-xl hover:bg-slate-50 transition-colors duration-300">
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 text-base leading-relaxed">
                        Financial transactions for inspections and deposits are
                        held securely, releasing only when milestones are met.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-5 items-start p-4 rounded-xl hover:bg-slate-50 transition-colors duration-300">
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 text-base leading-relaxed">
                        24/7 support from real estate experts who understand the
                        nuances of high-value property transactions.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-24 bg-navy-900 text-white relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 border-b border-navy-800 pb-8">
              <div>
                <span className="text-coral font-bold tracking-widest uppercase text-sm mb-2 block">
                  Why Choose Us
                </span>
              ...
              <p className="text-slate-400 max-w-md mt-6 md:mt-0 text-base leading-relaxed">
                Every feature is designed to reduce friction and increase
              ...
              {[
                {
                  ...
                  text: "We maintain a strict acceptance rate for agents, ensuring you deal with the top 5% of the market.",
                },
                {
                  icon: "psychology",
                  title: "Smart Matching",
                  text: 'Algorithms that understand "charm" and "potential," not just bedroom count and square footage.',
                },
                {
                  icon: "lock_clock",
                  title: "Instant Booking",
                  text: "Your time is valuable. Secure inspection slots instantly without the email tag.",
                },
                {
                  icon: "payments",
                  title: "Secure Transactions",
                  text: "Bank-grade security protocols for every payment, from inspection fees to holding deposits.",
                },
                {
                  icon: "headset_mic",
                  title: "Premium Support",
                  text: "A human expert is always available to navigate complex requirements or unique situations.",
                },
                {
                  icon: "notifications_active",
                  title: "Curated Alerts",
                  text: "Receive notifications only when it matters. Quality over quantity, always.",
                },
              ].map((item, index) => (
                <div
                  key={index}
                  className="p-8 rounded-3xl bg-navy-800/50 border border-navy-700 hover:bg-navy-800 transition-all duration-300 hover:-translate-y-1"
                >
        ...
        <section className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <span className="material-symbols-outlined text-coral text-5xl mb-6 opacity-80">
                format_quote
              </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-10 rounded-3xl shadow-card hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
                <p className="text-slate-600 text-lg leading-relaxed mb-8 font-medium italic">
                  "I posted my request on Tuesday and had three perfect viewings
                  booked by Friday. It saved me weeks of trawling through
                  property portals."
                </p>
                <div className="flex items-center gap-4 pt-6 border-t border-slate-100">
                  <img
                    ...
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuCVlk__cmTT_mEEk9l0T_beFDusijY8reJ1F1UjUXQLd3WCmFytkOjujA8pw4Yx8rZbhFUUvuSi6ypF4V1BGAS4Xx3semDgP7EbDusT_YqQdFeiyrU8ouhn7iuh3wWbWMX88NDA4xDQnOZSCSGZKc9GSUutXyGxCadHVGdAjw_MN3TMhmN-YfcRJ9lajhPxMar3nrf7SgYJ6rVCtLuo6h88wNJydpmf_K3b_mhaLGgirEc3mFa8TNDKVfT8gdxwP3EmVlloadE_ww"
                  />
                  <div>
              ...
              <div className="bg-white p-10 rounded-3xl shadow-card hover:shadow-xl transition-all duration-300 flex flex-col justify-between transform md:-translate-y-4">
                <p className="text-slate-600 text-lg leading-relaxed mb-8 font-medium italic">
                  "The ability to book inspections instantly is a game changer.
                  I knew exactly when I was seeing the property and the agent
                  was ready for me."
                </p>
                <div className="flex items-center gap-4 pt-6 border-t border-slate-100">
                  <img
                    alt="User"
                    className="w-14 h-14 rounded-full object-cover border-2 border-white shadow-md"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuBUUTue2nF1Ek4-dcltRTQSvYaqZCuvGijN0kIr9ZxpZQBMkb69FDaRguKGvT8uLeK6o5ekpm1J95TJJaBgULjPQIJITjGwqa42cLcMX7yKYzTzar2_rZ67dBxDE5DgeFH-T0t17VzMxnyFl1NbncHIRK3msA-fMDqkwAIsEbaosyTcUKf3rCKjMP6uAAVb_DUWSVx9MN8IT_YthzInsZeRwxfPVckpAnt9UBwwgIgGK7whQVbxPlpyM345QECpAxhw0JeCGSZ0eQ"
                  />
                  <div>
                    <h4 className="font-display text-lg font-bold text-navy-900">
                      Aspen Noonan
              ...
              <div className="bg-white p-10 rounded-3xl shadow-card hover:shadow-xl transition-all duration-300 flex flex-col justify-between">
                <p className="text-slate-600 text-lg leading-relaxed mb-8 font-medium italic">
                  "As an investor, time is money. DomiHive's matching system
                  brought the deals to me based on my criteria, making the
            ...
            <div className="space-y-4">
              <details className="group bg-surface rounded-xl p-6 open:bg-white open:shadow-lg open:ring-1 open:ring-slate-100 transition-all duration-300">
                <summary className="flex justify-between items-center cursor-pointer list-none">
                  ...
                  <span className="material-symbols-outlined text-slate-400 group-open:text-coral transition-colors transform group-open:rotate-45">
                    add_circle
                  </span>
                </summary>
                <p className="text-slate-600 text-base mt-4 leading-relaxed pr-8">
                  You submit a detailed request outlining your needs. Our
                  verified agents then review your request and send you
              ...
              <details className="group bg-surface rounded-xl p-6 open:bg-white open:shadow-lg open:ring-1 open:ring-slate-100 transition-all duration-300">
                <summary className="flex justify-between items-center cursor-pointer list-none">
                  <span className="font-display text-lg font-semibold text-navy-900">
                    Is there a fee to post a request?
                  </span>
                  <span className="material-symbols-outlined text-slate-400 group-open:text-coral transition-colors transform group-open:rotate-45">
                    add_circle
                  </span>
                ...
                <p className="text-slate-600 text-base mt-4 leading-relaxed pr-8">
                  Posting a request is free. You only pay a small fixed fee when
                  you decide to book a confirmed inspection for a property you
                  like.
                </p>
              </details>
              <details className="group bg-surface rounded-xl p-6 open:bg-white open:shadow-lg open:ring-1 open:ring-slate-100 transition-all duration-300">
                ...
                <p className="text-slate-600 text-base mt-4 leading-relaxed pr-8">
                  When an agent sends you a property match, you'll see available
                  viewing slots. Select a time that works for you and confirm
                  instantly.
                </p>
              </details>
            </div>
            ...
            <div className="bg-gradient-to-br from-navy-800 to-navy-900 rounded-[3rem] p-8 md:p-16 border border-navy-700 shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
                  ...
                  and <span className="text-coral">Start Acquiring?</span>
                </h2>
                <p className="text-slate-300 text-lg mb-8 max-w-lg font-light mx-auto">
                  Join the marketplace where the best properties find you.
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
              <div className="col-span-1 md:col-span-1">
                ...
                <p className="text-slate-500 text-sm leading-relaxed">
                  The premium marketplace for secure, efficient property
                  inspections and acquisitions.
                </p>
              </div>
              <div>
                <h4 className="font-bold mb-6 text-xs uppercase tracking-widest text-navy-900">
                  Services
                </h4>
            ...
            <div className="border-t border-slate-100 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-400">
              ...
              <div className="flex space-x-6 mt-4 md:mt-0">
                <Link className="hover:text-coral transition-colors" href="#">
                  <span className="material-symbols-outlined">
                    social_leaderboard
                  </span>
                </Link>
