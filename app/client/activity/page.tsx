                      ...
                      <div className="flex-grow">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="font-bold text-lg text-slate-800 dark:text-slate-100 mt-2">
                              Inspection Reminder: Your inspection is in 2 hours
                            </p>
                          </div>
                        ...
                        <div className="mt-3 pr-8">
                          <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
                            Location: 123, Queen Street, Lekki Phase 1 for
                            "Sunshine Villa". Please be on time.
                          </p>
                  ...
                  <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm rounded-2xl shadow-[0_8px_32px_0_rgba(100,100,150,0.15)] border border-white/50 dark:border-white/10 relative overflow-hidden">
                    <div className="p-5 flex items-start gap-5">
                      ...
                      <div className="flex-grow">
                        <div className="flex items-center justify-between">
                          <div>
                            <span className="text-sm font-semibold px-2.5 py-1 rounded-full bg-purple-100 text-purple-700 dark:bg-purple-900/50 dark:text-purple-300">
                              New Update
                            </span>
                            <p className="font-semibold text-slate-800 dark:text-slate-100 mt-2">
                              Agent replied to your question about "Sunshine
                              Villa"
                            </p>
                          </div>
                          <button className="text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200">
                        ...
                        <div className="mt-3 pr-8">
                          <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
                            "Yes, the apartment comes with a washing machine."
                          </p>
                          <div className="flex items-center gap-3">
                            <button className="bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-semibold py-2 px-4 rounded-lg transition-colors shadow-sm text-sm">
                              Mark as Read
                      ...
                      <div className="flex-grow">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="font-bold text-lg text-slate-800 dark:text-slate-100 mt-2">
                              5 new properties recommended for you!
                            </p>
                          </div>
                          <button className="text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200">
                            <ChevronUp className="w-6 h-6" />
                        ...
                        <div className="mt-3 pr-8">
                          <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
                            An agent has responded to your request with 5 new
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-medium text-sm text-slate-700 dark:text-slate-200">
                            Payment confirmed for "Sunshine Villa"
                          </p>
                    ...
                    <div className="p-4 flex items-center justify-between gap-5">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-500 dark:text-slate-400">
                            Update regarding your dispute for "Sunshine Villa".
                          </p>
                        </div>
                      </div>
                      <button className="text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200">
