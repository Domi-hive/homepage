...
export default function ClientProfilePage() {
  const [profileImage, setProfileImage] = useState(
    "https://lh3.googleusercontent.com/aida-public/AB6AXuApwz1HzKfzmiTi2UQsUJcW888s0VDgItEm-xhw7ioi7hzA5iXKdTooAJNi23OxGQOc6EdcnvtCqsPqCQtjebd3RrTQ3rU70soZYB989rU0V2xwU10nXOPhJp5OauflT4w4YdPaLYgvCUKTcmK4ileUe50q8glR9EXw6QSKFjXo4SAzVB2v_Ww33PACuP1RMXVBUxYrJwx_w9fhdfO5zk7wDg-oMOyLfPFNKy9AS6x9TgXe8AO1vmZTW9s3Ba9EcmOU1xeAqW6q8A",
  );
                ...
                <div className="space-y-5">
                  <label className="flex items-start justify-between cursor-pointer group">
                    <div>
                      ...
                      <p className="text-sm text-slate-500 dark:text-slate-400">
                        Get notified when agents respond to your requests
                      </p>
                    </div>
                    <input
                      type="checkbox"
                  ...
                  <label className="flex items-start justify-between cursor-pointer group">
                    <div>
                      ...
                      <p className="text-sm text-slate-500 dark:text-slate-400">
                        Get notified about price changes on saved properties
                      </p>
                    </div>
                    <input
                      type="checkbox"
              ...
              <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm p-8 rounded-2xl shadow-[0_8px_32px_0_rgba(100,100,150,0.15)] border border-white/50 dark:border-white/10">
                ...
                <form className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
                  ...
                  <div className="md:col-start-3">
                    <button
                      className="bg-gradient-to-r from-purple-500 to-blue-500 hover:opacity-90 text-white font-semibold py-3 w-full rounded-xl flex items-center justify-center gap-2 transition-opacity shadow-lg shadow-purple-500/30"
                      type="submit"
                    >
                      Update Password
                    </button>
